...
-- a SESSAO-12; o de dashboards é a SESSAO-10. Nada de regra de negócio agora.
-- ============================================================================
...
comment on table public.plt_tarefas is
  'Tarefas e delegação (RF-40 a RF-43). O comportamento é a SESSAO-12 — aqui só o lugar de guardar.';
...
-- entre a SESSAO-10 e o uso real, e migrar coluna a cada ajuste de gráfico
