...
1. **NUNCA commitar na main.** Toda sessão trabalha em branch própria (`sessao-NN-descricao`) e termina em PR para revisão do dono.
...
13. **Commits pequenos e descritivos; um PR por demanda.** Nada de PR gigante misturando assuntos.
...
→ conferir task list contra a demanda → PR (nunca main)
