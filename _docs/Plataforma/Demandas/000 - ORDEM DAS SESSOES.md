...
| 16º | [[SESSAO-16 - Dashboards de Verdade]] | Reconstruir os dashboards nos moldes de `docs/inspiracao/dashboards/` (D-42) | 13, 14 | 📐 pronta para code — ↩️ **cede a vez para a 20** (decisão do dono, 15/09): agora é a 20 que fixa o Recharts, e a 16 herda. Parte da `main` já com a 20 dentro (disputam `App.tsx`, `Layout.tsx`, `tokens.css`) |
