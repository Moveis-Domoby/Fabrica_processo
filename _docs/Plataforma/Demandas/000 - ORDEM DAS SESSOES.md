...
>
> ⚠️ **O número da sessão é ID, não ordem** (M-09). A ordem de execução é a coluna "Ordem" desta tabela — reordenada em 24/08 pela D-11 (API de entrada antecipada) e **em 27/08 pela D-23** (antecipação da 13 desfeita; nasce a SESSAO-14 de publicação; Bloco 2 = 5º→9º, Bloco 3 = 10º→14º).
...
| 5º | [[SESSAO-05 - Timers e Eventos de Tempo]] | Fila (do setor) vs execução (da pessoa), eventos imutáveis — **a razão de existir** | 04 | 🔶 rascunho |
...
| 8º | [[SESSAO-14 - Publicacao no Ar]] | **A plataforma hospedada e acessível dos tablets do galpão** (Q-62/Q-60); encerra a permissão da D-19 | 07 | 🔶 rascunho |
| 9º | [[SESSAO-13 - Entrada de Pedidos via n8n]] | **Pedido do Tiny vira card no PCP sozinho** (n8n empurra) — ↩️ reposicionada pela D-23 | 04 | 🔶 rascunho |
| 10º | [[SESSAO-08 - Dashboards e Visualizacoes Salvas]] | Produtividade + qualidade sobre dados REAIS, comparativo fila/execução, views salvas | 06, 07 | 🔶 rascunho |
| 11º | [[SESSAO-10 - API Aberta e Integracao n8n]] | API completa: CRUD/mover, gestão de chaves, webhooks, ponte ROTAS | 05, 13 | 🔶 rascunho |
| 12º | [[SESSAO-09 - Tarefas e Delegacao]] | Meus afazeres/time, delegação aleatória e direta | 04 | 🔶 rascunho |
| 13º | [[SESSAO-11 - Automacoes Internas]] | Builder "quando X, faça Y" + central de notificações | 10 | 🔶 rascunho |
| 14º | [[SESSAO-12 - Painel Admin Completo]] | Consolidação: gestão total de setores, etapas, usuários, chaves, automações | 11 | 🔶 rascunho |
