...
| 22º 🆕 | [[SESSAO-22 - Producao - Filas Reais Tempo de PCP e Paginacao]] | Fim da coluna "Chegada", tempo de PCP verdadeiro no card, 10 cards por etapa + "Ver mais", regra "cada tela requisita só o que mostra", 1 pedido por vez + pausa por líder | 16 | 🔨 em execução — código pronto e testado, handoff em [[handoff_2026_09_21_sessao22_filas_tempo_pausa]]; **aguarda o F-08 (aplicar migration 29 + manutenções) e o merge (D-20)** |
