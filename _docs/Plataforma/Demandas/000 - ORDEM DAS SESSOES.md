...
| 13º | [[SESSAO-13 - Navegacao Perfil e Identidade]] | **A reforma da casca (D-36):** sidebar pai→filho recolhível, rotas `/pai/filho`, voltar em toda tela, sino no topo + popover corrigido, Meu Perfil com 8 temas (D-41), login novo, log de tudo (D-40) | 07, 12 | 📐 pronta para code |
