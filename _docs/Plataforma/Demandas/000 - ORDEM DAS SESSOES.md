...
| 16º | [[SESSAO-16 - Dashboards de Verdade]] | Reconstruir os dashboards nos moldes de `_docs/Plataforma/Inspiracao/dashboards/` (D-42) | 13, 14 | 📐 pronta para code — **é a próxima**. Herda Recharts 3.9.2 e tokens de série da 20 (disputam `App.tsx`, `Layout.tsx`, `tokens.css`) |
