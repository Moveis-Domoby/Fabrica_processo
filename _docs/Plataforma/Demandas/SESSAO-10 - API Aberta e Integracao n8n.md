---
titulo: "SESSAO-10 — API Aberta e Integração n8n"
tipo: demanda
status: rascunho
data: 2026-08-19
...
# 🎯 SESSAO-10 — API Aberta e Integração n8n

## O que é

A porta de integrações completa: API aberta para criar, editar, mover e excluir cards (D-03), webhooks de saída e a ponte com o ClickUp ROTAS. **A entrada de pedidos Tiny → PCP já existe desde a [[SESSAO-13 - Entrada de Pedidos via n8n]]** (D-11) — esta sessão completa o resto e formaliza a gestão de chaves.
...
- **Revisar a entrada da SESSAO-13:** migrar a chave manual daquela fase para a gestão formal de chaves desta sessão.
